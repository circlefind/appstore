          ...
          <q-card-section>
            ...
            >
              <template v-slot:body="props">
                <q-tr :props="props">
                  <q-td auto-width key="bankname" :props="props">{{
                    props.row.bankname
                  }}</q-td>
                  <q-td key="branch" :props="props">{{
                    props.row.branch
                  }}</q-td>
                  <q-td key="accname" :props="props">{{
                    props.row.accname
                  }}</q-td>
                  <q-td key="accnumber" :props="props">{{
                    props.row.accnumber
                  }}</q-td>
    ...
    >
      <q-card class="q-pa-none" style="width: 420px">
        ...
        <q-card-section class="text-info"
          >Hapus BANK Transfer {{ this.formupdate.bankname }}?</q-card-section
        >
        <q-card-section align="right">
          <q-btn
            unelevated
